...
filter_sizes_list = ["100,500", "500,1000", "100,1000", "1000,500", "1000,100", "100,100, 1000",  "500,500, 5000", "1000,1000,1000", "100,500, 1000"]
keep_prob_list = [ 0.25, 0.5, 0.6,  0.7, 1]


# # Training
# # ==================================================
log = open("/cis/home/ajacob/Documents/courses/Sem2/ML/Project/cnn-text-classification-tf/vec_mlp/log.txt","w")
        ...
        for dropout_keep_prob in keep_prob_list:
            ...
            with tf.Graph().as_default():
                ...
                with sess.as_default():
                    ...
                    print("Embedding dim: {}, Layers: ({}), Dropout {:g}, Validation acc: {:g}".format(embedding_dim, filter_sizes, dropout_keep_prob, best_val), file = log)
